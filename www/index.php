				...
				<header id="header" class="container">
					<div class="row">
						<div class="12u">
							...
							<!-- Logo -->
								<h1><a href="#" id="logo"><img src="img/logo.png"></a></h1>
							
							<!-- Nav -->
								<nav id="nav">
									<a href="index.html">Homepage</a>
									<a href="threecolumn.html">Over ons</a>
									<a href="twocolumn1.html">Zorgvergoedingen</a>
									<a href="twocolumn2.html">Acties/Nieuws</a>
